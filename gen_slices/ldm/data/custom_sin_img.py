...
class CustomSinImgBase(Dataset):
    def __init__(self,
                 txt_file,
                 data_root,
                 split,
...
class CustomSinImgTrain(CustomSinImgBase):
    def __init__(self, **kwargs):
        super().__init__(txt_file="../data/custom_sin_img/03_splits/train.lst", data_root="../data/custom_sin_img", split='train', **kwargs)


class CustomSinImgValidation(CustomSinImgBase):
    def __init__(self, flip_p=0., **kwargs):
        super().__init__(txt_file="../data/custom_sin_img/03_splits/val.lst", data_root="../data/custom_sin_img", split='val',
                         flip_p=flip_p, **kwargs)

class CustomSinImgTest(CustomSinImgBase):
    def __init__(self, flip_p=0., **kwargs):
        super().__init__(txt_file="../data/custom_sin_img/03_splits/test.lst", data_root="../data/custom_sin_img", split='test',
                         flip_p=flip_p, **kwargs)